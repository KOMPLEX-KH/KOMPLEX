...
import BlogEditor from "@/components/helper/Editor";
...
export function ExerciseCreationBox({
  questions,
  onQuestionsChange,
        ...
        {questions.length === 0 ? (
          <div className="text-center py-12 text-gray-500">
            <div className="flex items-center flex-col justify-center gap-2">
              ...
              <button
                onClick={addQuestion}
                className="mt-2 bg-indigo-600 hover:bg-indigo-700 text-white px-4 py-2 rounded-lg transition-colors font-medium flex items-center gap-2"
              >
                <Plus size={18} />
                បន្ថែមសំណួរ
              </button>
            ...
            >
              ...
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-3">
                  <div
                    className={`w-8 h-8 rounded-full flex items-center justify-center text-white font-bold text-sm bg-indigo-500
                                        }`}
                  >
                    {questionIndex + 1}
                  </div>
