    ...
    <div className="w-full">
      ...
      <div className="rounded-3xl border-1 border-gray-200 overflow-hidden mb-4 mt-4">
        <div className="grid md:grid-cols-5 gap-8 p-5">
          ...
          <div className="md:col-span-3 flex flex-col justify-between">
            <div>
              <h1 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4">{book.title}</h1>
              ...
              <div className="mb-4 flex items-center gap-5 ">
                <div className="flex items-center gap-3 ">
                  ...
                  <div>
                    ...
                    <p className="text-[15px] font-medium text-gray-900">{book.author}</p>
                  </div>
                </div>
              ...
              <div>
                ...
                <p className="text-gray-700 leading-relaxed text-[15px]">{book.description}</p>
              </div>
      ...
      {relatedBooks.length > 0 && (
        <section className="flex flex-col gap-4 bg-white shadow-sm rounded-3xl p-4 border-1 border-gray-200">
          <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-gray-800">សៀវភៅពាក់ព័ន្ធផ្សេងៗទៀត</h2>
          <div
            className="
              grid grid-flow-col
              auto-cols-[65%]
