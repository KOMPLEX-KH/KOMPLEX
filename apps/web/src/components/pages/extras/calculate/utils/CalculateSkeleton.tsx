    ...
    <div className="min-h-screen animate-pulse">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12">
          <div className="bg-gradient-to-r from-blue-600 to-blue-700 py-8 px-4 rounded-t-2xl">
            <div className="max-w-6xl mx-auto flex flex-col justify-center items-center">
              <div className="flex items-center gap-3 mb-2 justify-center">
                <div className="w-8 h-8 bg-white rounded-full"></div>
                <div className="h-10 w-56 bg-white rounded-lg"></div>
              </div>

              <div className="flex w-full items-center mt-4 justify-center sm:justify-end rounded-md">
                <div className="bg-gray-300 rounded-full p-1 w-full sm:w-[260px] flex gap-2">
        ...
        >
          {[...Array(skeletonCount)].map((_, i) => (
            <div key={i} className="w-full border-1 border-gray-400 rounded-3xl shadow-lg bg-white p-4">
        ...
        <div className="flex flex-col items-center mb-8">
          <div className="px-16 py-4 rounded-full text-xl font-bold shadow-xl bg-gray-300 w-[250px]"></div>
        </div>

        {/* Result Card Skeleton */}
        <div className="w-full flex flex-col shadow-2xl rounded-xl p-4 bg-white">
          <div className="flex items-center justify-center mt-4">
            <div className="h-10 w-72 bg-gray-300 rounded-md"></div>
          </div>

          <div className="flex items-center justify-center w-full p-4">
            <div className="flex items-center justify-center gap-6 sm:gap-8 md:gap-10 rounded-2xl p-4 scale-90 sm:scale-95 md:scale-100 w-full max-w-4xl">
              {/* Final Result */}
              ...
              {/* Total Score */}
              <div className="flex flex-col justify-center items-center gap-2 bg-gray-300 rounded-2xl p-3 sm:p-4 w-28 sm:w-32 md:w-35 shadow-lg">
          ...
          <div className="p-2">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[...Array(skeletonCount)].map((_, i) => (
                <div
                  key={i}
                  className="bg-gray-200 rounded-xl p-5 flex relative flex-col items-start h-40"
                >
                  ...
                  <div className='absolute left-0 bottom-0 bg-gray-400 p-2 rounded-bl-xl w-17 rounded-tr-[80px]'>
