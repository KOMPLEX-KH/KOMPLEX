    ...
    <div id="result-section" className="w-full flex flex-col shadow-2xl rounded-xl p-4">
      ...
      <div className="flex items-center justify-center w-full p-4">
        <div className="flex items-center justify-center gap-6 sm:gap-8 md:gap-10 
                        rounded-2xl shadow-xl p-4 bg-white 
          ...
          <div className="flex flex-col justify-center items-center gap-2 
                          bg-blue-600 rounded-2xl p-3 sm:p-4 w-28 sm:w-32 md:w-35 shadow-lg">
          ...
          <div className="flex flex-col justify-center items-center gap-2 w-20 sm:w-24 md:w-28">
            ...
            <p className="text-red-500 text-3xl sm:text-4xl font-bold">{result.grade}</p>
          </div>
      ...
      <div className="p-2">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {subjects.map((subj) => {
            ...
            return (
              <div key={subj.key}
                className="bg-white rounded-xl shadow-lg p-5 flex relative flex-col items-start"
              >
                ...
                <div className='absolute left-0 bottom-0 bg-black p-2 rounded-bl-xl w-17 rounded-tr-[80px]'>
