...
export default function AboutFeatures() {
  const features = [
    {
      media: (
        <div className="bg-white dark:bg-zinc-900 rounded-3xl p-2 shadow-lg">
          <img
    ...
    // },
    {
      media: (
        <div className="bg-white dark:bg-zinc-900 rounded-3xl p-2 shadow-lg">
          <div className="w-full h-80 bg-zinc-100 dark:bg-zinc-800 rounded-3xl flex items-center justify-center">
            <img
      ...
      title: (
        <div className="flex items-center">
          ...
          <span className="text-zinc-900 dark:text-zinc-100 mr-2">រា</span> AI
        </div>
      ),
      icon: Bot,
      listItems: [
  ...
  return (
    <section className="py-20 px-5 bg-white dark:bg-zinc-900 text-zinc-900 dark:text-zinc-100">
