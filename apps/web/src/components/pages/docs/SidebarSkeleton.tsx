...
export default function SidebarSkeleton() {
    ...
    return (
        <div className="hidden lg:block w-70 bg-white backdrop-blur-md border-r border-indigo-500/10 overflow-y-auto fixed h-[calc(100vh-56px)] top-28 z-40 shadow-lg scrollbar-hide">
            <div className="pb-12">
                <div className="p-4">
                    <div className="space-y-4">
                        ...
                        {Array.from({ length: 5 }).map((_, lessonIndex) => (
                            <div key={lessonIndex} className="space-y-2">
                                ...
                                <div className="w-full flex items-center justify-between p-4 rounded-full shadow-lg shadow-indigo-500/15 bg-gray-50">
