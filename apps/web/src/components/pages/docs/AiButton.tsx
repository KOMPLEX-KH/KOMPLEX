        ...
        <div className="fixed bottom-4 right-4 z-50 flex items-center gap-2">
            ...
            >
                <div className="relative flex items-center">
                    <span
                        className={`pointer-events-none absolute right-full mr-2 overflow-hidden rounded-full border shadow-lg shadow-indigo-500/20 transition-all duration-300 ease-out max-w-0 group-hover:max-w-[240px] bg-transparent group-hover:bg-indigo-50 group-hover:border-indigo-600`}
                    >
                        <span
