...
export default function Skeleton() {
    ...
    const genericDefinition = {
        title: "ចំណងជើងមេរៀន",
        content:
            "មេរៀននេះស្តីអំពីប្រធានបទសំខាន់។ វាផ្តល់នូវសេចក្តីពន្យល់មូលដ្ឋាន និងព័ត៌មានសំខាន់ៗ ដើម្បីជួយឱ្យអ្នកចាប់ផ្តើមបានយល់។",
    };
    ...
    const genericExample = {
        ...
        content:
            "នេះជាឧទាហរណ៍មួយដើម្បីបង្ហាញពីរបៀបដែលអ្នកអាចអនុវត្តចំណេះដឹងដែលបានរៀន។",
        steps: [
            {
                title: "ជំហានទី១",
        ...
        <div className="relative w-full h-full min-h-[600px] overflow-hidden">
            ...
            <div className="absolute inset-0 opacity-50 pointer-events-none h-full">
                <div className="p-2 space-y-4">
                    ...
                    />
                    <TipBox title={genericTip.title} content={genericTip.content} />
                    <HintBox content={genericHint.content} />
                    <ExampleBox
