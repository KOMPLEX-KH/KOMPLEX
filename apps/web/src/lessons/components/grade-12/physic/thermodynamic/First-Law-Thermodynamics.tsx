        ...
        <ol className="grid grid-cols-2 sm:grid-cols-4 gap-2 text-[13px]">
          <li>
            <a href="#sec-overview" className={chip}>
              ...
              ទ្រឹស្តីបទនៃច្បាប់ទី១នៃទែម៉ូឌីណាមិច
            </a>
          </li>
          <li>
            <a href="#sec-work" className={chip}>
              <span className="font-semibold">2.</span> កម្មន្តគ្រប់ករណី
            </a>
          </li>
          <li>
            <a href="#sec-internal-energy" className={chip}>
              <span className="font-semibold">3.</span> ថាមពលក្នុង
            </a>
          </li>
          <li>
            <a href="#sec-conventional-internal-energy" className={chip}>
              <span className="font-semibold">4.</span> បម្រែបម្រួលថាមពលក្នុង
            </a>
          </li>
          <li>
            <a href="#sec-first-law-thermodynamic" className={chip}>
              <span className="font-semibold">5.</span> ច្បាប់ទី១នៃទែម៉ូឌីណាមិច
            </a>
          </li>
          <li>
      ...
      <DefinitionBox
        ...
        content={
          <div className="space-y-6">
            ...
            <Section
              no={1}
              title="ទ្រឹស្តីបទនៃច្បាប់ទី១នៃទែម៉ូឌីណាមិច"
              id="sec-overview"
            >
              <TipBox
                title="ទ្រឹស្តីបទ"
                ...
                steps={[
                  {
                    ...
                    content: (
                      <MathLine
                        math={String.raw`W=\tfrac{1}{2}(P_f+P_i)\Delta V`}
                      />
                    ),
                  },
                  {
                    ...
                    content: (
                      <MathLine
                        math={String.raw`W=\tfrac{1}{2}(3.0\times10^{5})(0.002)=3.0\times10^{2}\,J`}
                      />
                    ),
                  },
                ]}
              ...
              <ExampleBox
                question={
                  <p>
                    ...
                    <InlineMath math="T=300\,K" />,{" "}
                    <InlineMath math="V_i=5\,L" />,{" "}
                    <InlineMath math="V_f=10\,L" />។ គណនា{" "}
                    <InlineMath math="W" />។
                  </p>
                }
                steps={[
                  {
                    title: "រូបមន្ត",
                    content: <MathLine math={String.raw`W=nRT\ln(V_f/V_i)`} />,
                  },
                  {
                    title: "ដាក់តម្លៃ",
                    content: (
                      <MathLine
                        math={String.raw`W=0.5\times8.314\times300\times\ln 2\approx 8.64\times10^{2}\,J`}
                      />
                    ),
                  },
                ]}
            ...
            <Section no={3} title="ថាមពលក្នុង" id="sec-internal-energy">
              <TipBox
                ...
                content={
                  <div className="space-y-2">
                    <p>
                      <strong>ថាមពលក្នុង</strong>
                      គឺជាថាមពលសុីនេទិចសរុបរបស់ឧស្ម័ន។{" "}
                    </p>
                    <div className="grid gap-3 sm:grid-cols-2">
                      {/* Isochoric */}
                      <div className="rounded-xl border-l-4 border-sky-500 bg-sky-50/70 p-4 shadow-sm">
            ...
            <Section
              ...
              id="sec-conventional-internal-energy"
            >
              <div className="space-y-2">
                <div className="grid gap-3 sm:grid-cols-2">
                  {/* Isochoric */}
                  ...
                  <div className="rounded-xl border-l-4 border-sky-500 bg-sky-50/70 p-4 shadow-sm">
                    ...
                    <MathScroll
                      math={String.raw`\Delta U=\tfrac{3}{2}K_B\Delta T`}
                    />
                    {/* <p className="text-sm text-slate-700">តំបន់ជារាងចតុកោណក្រោមខ្សែក្រាប</p> */}
                  </div>
                </div>
            ...
            <Section
              no={5}
              title="ច្បាប់ទី១នៃទែម៉ូឌីណាមិច"
              id="sec-first-law-thermodynamic"
            >
              <TipBox
                title="ទ្រឹស្តីបទ"
                content={
                      ...
                      content={
                        <>
                          <ul className="text-sm text-slate-700 space-y-1 list-disc pl-5">
                            <li>
                              បើឧស្ម័នធ្វើឬបំពេញកម្មន្ត(<b>W &gt; 0</b>)
                            </li>
                            <li>
                              បើឧស្ម័នបញ្ចេញកម្តៅឬរងកម្មន្ត(<b>W &lt; 0</b>)
                            </li>
                            <li>
                              បើឧស្ម័នស្រូបកម្តៅ(<b>Q &gt; 0</b>)
                            </li>
                            <li>
                              បើឧស្ម័នបញ្ចេញកម្តៅ(<b>Q &lt; 0</b>)
                            </li>
                            <li>
                              បើថាមពលក្នុងកើន(<b>ΔU &gt; 0</b>)
                            </li>
                            <li>
                              បើថាមពលក្នុងថយចុះ(<b>ΔU &lt; 0</b>)
                            </li>
                          </ul>
                        </>
                      }
                    ...
                    <TipBox
                      ...
                      content={
                        <ul className="list-disc pl-6 space-y-1">
                          <li>
                            <b>លំនាំអាព្យាបាទិច</b> (<InlineMath math="Q=0" />
                            )​​ ⟹​ <InlineMath math="W =- \Delta U" />។
                          </li>
                          <li>
                            <b>លំនាំអុីសូករ</b> (<InlineMath math="W=0" />) ⟹
                            <InlineMath math="\Delta U=Q" />។
                          </li>
                          <li>
                            <b>ថាមពលក្នុង</b> (<InlineMath math="\Delta U=0" />)
                            ⟹ <InlineMath math="Q=W" />។
                          </li>
                        </ul>
                      }
              ...
              <ExampleBox
                ...
                steps={[
                  {
                    ...
                    content: (
                      <MathLine
                        math={String.raw`\Delta U=\tfrac{3}{2}nR\Delta T=\tfrac{3}{2}(1)(8.314)(50)=6.24\times10^{2}\,J`}
                      />
                    ),
                  },
                  {
                    ...
                    content: (
                      <MathLine
                        math={String.raw`W=0\ \Rightarrow\ Q=\Delta U`}
                      />
                    ),
                  },
                ]}
                answer={
                  <InlineMath
                    math={String.raw`Q=\Delta U\approx 6.24\times10^{2}\,J`}
                  />
                }
              />
            </Section>
                ...
                questions={[
                  {
                    ...
                    question: (
                      <p>
                        ក្នុងដំណើរការ isochoric តើ <InlineMath math="W" />{" "}
                        ស្មើអ្វី?
                      </p>
                    ),
                    options: [
                  ...
                  },
                  {
                    ...
                    question: (
                      <p>
                        ...
                        <InlineMath math="P_f" />។ តើ <InlineMath math="W" />{" "}
                        ស្មើអ្វី?
                      </p>
                    ),
                    options: [
                  ...
                  },
                  {
                    ...
                    options: [
                      <BlockMath
                        key="a"
                        math={String.raw`U=\tfrac{3}{2}nRT`}
                      />,
                      <BlockMath
                        key="b"
                        math={String.raw`\Delta U=\tfrac{3}{2}nR\Delta T`}
