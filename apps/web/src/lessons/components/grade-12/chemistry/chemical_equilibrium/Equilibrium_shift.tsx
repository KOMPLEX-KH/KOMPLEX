      ...
      <>
        <div className="flex flex-col items-start gap-3">
          <p>
            ...
            (មិនមានស្ថិរភាព ) ហេីយវាបំបែកជាឧស្ម័នភ្លាម ។
          </p>
        </div>
      </>
    ),
  ...
  tip: {
    ...
    content: (
      <>
        <div className="flex flex-col items-start gap-3">
          <p>
            បេីគេបន្ថែមអុីយ៉ុងណាមួយចូលទៅក្នុងសូលុយស្យុងមួយទៀតដែលមានវត្តមានអុីយ៉ុងនោះដែរ
            និងធ្វេីឲមានការប្រែប្រួលដល់លំនឹង ដូចជាបណ្តាលឲកេីតជាកករ
