    ...
    content: (
      <>
        <div className="flex flex-col items-start">
          <p>
            {" "}
            <span className="font-bold">អត្រាកម្មអាសុីត-បាស</span>{" "}
            ជាលំនាំឬបច្ចេកទេសដែល
            គេប្រេីនៅទីពិសោធន៍ដេីម្បីកំណត់កំហាប់សូលុយស្យុងអាសុីត
            ឬបាសមិនស្គាល់កំហាប់ ដោយប្រេីសូលុយស្យុងបាស​
            ឬអាសុីតដែលស្គាល់កំហាប់ច្បាស់លាស់។ សូលុយស្យុងដែលគេស្គាល់កំហាប់ ហៅថា{" "}
            <span className="font-bold">សូលុយស្យុងស្តង់ដារ</span> ។
          </p>
        </div>
      </>
    ),
    ...
    content: (
      <>
        <div className="flex flex-col items-start">
          <p>
            {" "}
            <span className="font-bold">ចំណុចសមមូលអាសុីត-បាស</span>{" "}
            ជាចំណុចដែលបរិមាណអាសុីត និងបរិមាណបាសប្រតិកម្មអស់ពីសូលុយស្យុង ។
            គេប្រេីអង្គធាតុចង្អុលពណ៌ជាសញ្ញាប្រាប់ឲដឹងថាចំណុចសមមូលកេីតមាន ។
          </p>
        </div>
      </>
    ),
    ...
    content: (
      <>
        <div className="flex flex-col items-start">
          <p>
            {" "}
            <span className="font-bold">អង្គធាតុចង្អុលពណ៌</span>{" "}
            ជាសារធាតុសរីរាង្គដែលពណ៌របស់វាអាស្រ័យនឹងតម្លៃ pH ។
          </p>
        </div>
      </>
    ),
