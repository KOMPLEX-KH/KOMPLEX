...
const SecondTopicContent: TopicContent = {
  ...
  tip: {
    ...
    content: (
      <>
        <p>
          អាសុីតជាអេឡិចត្រូលីត និងអាចប្រែពណ៌អង្គធាតុចង្អុលពណ៌បាន។
          អាសុីតមានប្រតិកម្មជាមួយបាសផ្តល់ផលជា អំបិលនិងទឹក។
        </p>
      </>
    ),
  },
  ...
  definition: {
    ...
    content: (
      <>
        <div className="flex flex-col items-start">
          <p>
            អុីដ្រូអាសុីតគឺជាអាសុីតដែលផ្សំដោយ H និងធាតុមួយផ្សេងទៀតដែលមានកម្រិត
            អេឡិចត្រូអវិជ្ជមានខ្លាំង។
          </p>
        </div>
      </>
    ),
  ...
  definition: {
    ...
    content: (
      <>
        <div className="flex flex-col items-start">
          <p>
            អុកសុីអាសុីតគឺជាអាសុីតដែលមានធាតុផ្សំ អុីដ្រូសែន អុកសុីសែន
            និងធាតុទី៣ដែល ភាគច្រេីនជាអលោហះ។
          </p>
        </div>
      </>
    ),
    ...
    content: (
      <>
        ...
        <ul className="list-disc pl-5">
          ...
          <li>
            បេីសិនជាអាសុីតខ្សោយ ព្រួញនៃសមីការត្រូមានទិសពីរ
            គឺទិសមុនប្រតិកម្មនិងក្រោយប្រតិកម្ម
          </li>
        </ul>
      </>
    ),
  ...
  example2: {
    question: [
      <div className="flex flex-col items-start gap-3" key="q2">
        ...
        <p>
          ចូរកំណត់អាសុីតទាំងនេះជាអុីដ្រូអាសុីត និងអុកសុីអាសុីត
          ព្រមទាំងសរសេរសមីការអាសុីត HBr និង HI
...
const SixthTopicContent: TopicContent = {
  ...
  tip: {
    ...
    content: (
      <>
        <p>
          បាសជាអេឡិចត្រូលីត និងអាចប្រែពណ៌បានអង្គធាតុចង្អុលពណ៌បាន។
          បាសមានប្រតិកម្មជាមួយអាសុីតផ្តល់ផលជា អំបិលនិងទឹក។
        </p>
      </>
    ),
  },
          ...
          <ul className="list-disc pl-5 flex flex-col gap-4">
            ...
            <div className="flex flex-col items-start gap-3">
              <div className="flex items-center gap-2 flex-wrap">
                <li>
                  អាសុីតខ្សោយ
                  ជាអាសុីតដែលបំបែកជាអុីយ៉ុងអុីដ្រូញ៉ូមមិនសព្វក្នុងទឹក។
                </li>
              </div>
              <div className="flex items-center gap-2 flex-wrap">
                <span>ឧទាហរណ៍</span>
    ...
    <div>
      ...
      <div>
        ...
        {FifthTopicContent.example2 && (
          <ExampleBox
            question={FifthTopicContent.example2.question}
            steps={FifthTopicContent.example2.steps}
            answer={FifthTopicContent.example2.answer}
          />
        )}
      </div>
      <div>
      ...
      <div>
        {NinthTopicContent.definition && (
          <DefinitionBox
            title={NinthTopicContent.definition.title}
            content={NinthTopicContent.definition.content}
          />
        )}
        {NinthTopicContent.tip && (
          <TipBox
            title={NinthTopicContent.tip.title}
            content={NinthTopicContent.tip.content}
          />
        )}
        {NinthTopicContent.example && (
          <ExampleBox
            question={NinthTopicContent.example.question}
            steps={NinthTopicContent.example.steps}
            answer={NinthTopicContent.example.answer}
          />
        )}
      </div>
      <div>
