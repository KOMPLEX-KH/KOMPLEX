  ...
  tip: {
    ...
    content: (
      <>
        <div className="flex items-start gap-3 flex-col">
          <p>
            ល្បឿនកំណអង្គធាតុកកេីត
            និងបំបាត់អង្គធាតុប្រតិករកេីនជាមួយកំណេីនសីតុណ្ហភាព។
        ...
        <div className="flex items-start gap-3 flex-col">
          ...
          <ul className="list-disc pl-5 flex flex-col items-start gap-4">
            <div className="flex flex-col gap-2">
              <li>
                កាតាលីសអូម៉ូសែន ៖
                គឺជាកាតាលីសដែលកាតាលីករនិងអង្គធាតុប្រតិករមានផាសដូចគ្នា។
              </li>
              <span className="text-[13px]">
            ...
            <div className="flex flex-col gap-2">
              <li>
                កាតាលីសអេតេរ៉ូសែន
                ៖ជាកាតាលីសដែលកាតាលីករនិងអង្គធាតុប្រតិករមានផាសខុសគ្នា។
              </li>
              <span className="text-[13px]">
            ...
            <div className="flex flex-col gap-2">
              <li>
                កាតាលីសអង់ស៊ីម ៖
                ជាកាតាលីសដែលកាតាលីករជាអង់ស៊ីម(ដូចជាប្រូតេអ៊ីនដែលបង្កឡើង
                ពីភាវរស់)។
              </li>
              <span className="text-[13px]">
                <InlineMath math="H_{2}O_{2} \xrightarrow{ អង់សុីមក្នុងថ្លេីម } H_{2}O + \frac{1}{2} O_{2}" />
              </span>
            </div>
          </ul>
        </div>
...
const NinethTopicContent: TopicContent = {
  ...
  tip: {
    ...
    content: (
      <>
        <p>
          ស្វ័យកាតាលីសគឺជាកាតាលីសដែលអង្គធាតុកកេីតមាននាទីជាកាតាលីករក្នុងប្រតិកម្ម
          ។
        </p>
      </>
    ),
  ...
  example: {
    question: [
      <div className="flex flex-col items-start gap-3" key="q1">
        <p>
          រេដុកម្មអុីយ៉ុងពែម៉ង់កាណាត <InlineMath math="MnO_{4}^{-} " />{" "}
          ដោយអាសុីតអុកសាលិច <InlineMath math="H_{2}C_{2}O_{4}" />។
        </p>
        <img className="w-130" src="/chemistry/pic24.png" alt="" />
        <p>
          អុីយ៉ុង <InlineMath math="Mn^{2+} " />{" "}
          មានតួនាទីជាកាតាលីករក្នុងប្រតិកម្ម ។
        </p>
      </div>,
    ],
  },
