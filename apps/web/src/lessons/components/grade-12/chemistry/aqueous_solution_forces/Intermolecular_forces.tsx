    ...
    content: (
      <>
        <ul className="list-disc pl-3 flex flex-col items-start gap-5">
          <li>
            សមាសធាតុអុីយ៉ុងផ្សំឡេីងពីអុីយ៉ុងវិជ្ជមាននិងអវិជ្ជមាន។
            អុីយ៉ុងដែលមានបន្ទុកផ្ទុយគ្នាប្រទាញគ្នាទៅវិញទៅមកបង្កេីតបានជាកម្លាំងអុីយ៉ុង(កម្លាំងអេឡិចត្រូស្តាទិច)។
          </li>
          <li>
            អុីយ៉ុងដែលមានទំហំតូចចូលផ្សំគ្នាបង្កេីតបានជាសមាសធាតុមានចំណុចរំពុះខ្ពស់ជាងអុីយ៉ុងដែលមានទំហំធំ។
          </li>
          <li>
            សមាសធាតុបង្កពីអុីយ៉ុងដែលមានបន្ទុកធំមានចំណុចរំពុះខ្ពស់ជាងសមាសធាតុដែលបង្កពីអុីយ៉ុងដែលមានបន្ទុកតូច។
          </li>
        </ul>
      </>
    ),
    ...
    content: (
      <>
        <div className="flex flex-col items-start">
          <p>
            កម្លាំងអន្តរម៉ូលេគុលគឺជាកម្លាំងប្រទាញគ្នាទៅវិញទៅមករវាងម៉ូលេគុលនិងម៉ូលេគុល។
          </p>
        </div>
      </>
    ),
  ...
  tip: {
    ...
    content: (
      <>
        <ul className="list-disc pl-3 flex flex-col items-start gap-5">
          <li>
            កម្លាំងអាចជាកម្លាំងឌីប៉ូល-ឌីប៉ូល និងកម្លាំងរបាយឡុនដុន។
            កម្លាំងទាំងពីរនេះអាចកេីតមាននៅពេលវានៅជិតគ្នា។
            កម្លាំងនេះខ្សោយកាលណាម៉ូលេគុលនៅឆ្ងាយពីគ្នាខ្លាំង
            ឬមានសីតុណ្ហភាពជិតតម្លៃសូន្យដាច់ខាត (0 K = -273.15 °C)
          </li>
          <li>
            ម៉ូលេគុលដែលមានចំណុចរំពុះខ្ពស់ជាង មានកម្លាំងអន្តរម៉ូលេគុលខ្ពស់ជាង។
          </li>
        </ul>
      </>
    ),
  ...
  definition: {
    ...
    content: (
      <>
        <div className="flex flex-col items-start">
          <p>
            កម្លាំងរបាយឡុនដុនគឺជាកម្លាំងប្រទាញគ្នារវាងម៉ូលេគុល
            និងម៉ូលេគុលដែលមិនប៉ូលែ។
          </p>
        </div>
      </>
    ),
  ...
  tip: {
    ...
    content: (
      <>
        <ul className="list-disc pl-3 flex flex-col items-start gap-5">
          <li>
            ម៉ូលេគុលដែលមានម៉ាសកាន់តែធំ ឬមានអេឡិចត្រុងកាន់តែច្រេីន
            នោះមានកម្លាំងប្រទាញរវាងម៉ូលេគុល និងម៉ូលេគុលកាន់តែខ្លាំង។
            កម្លាំងប្រទាញកាន់តែខ្លាំងចំណុចរលាយ ឬចំណុចរំពុះកាន់តែខ្ពស់។
          </li>
          <li>
            កម្លាំងរបាយឡុនដុនមានលក្ខណៈខ្សោយជាងគេក្នុងចំណោមកម្លាំងអន្តរម៉ូលេគុលទាំងអស់។
          </li>
          <li>
            គេពិចារណាទៅលេីកម្លាំងរបាយឡុនដុនតែក្នុងករណីម៉ូលេគុលមិនប៉ូលែប៉ុណ្ណោះ។
          </li>
        </ul>
      </>
    ),
  ...
  tip: {
    ...
    content: (
      <>
        <ul className="list-disc pl-3 flex flex-col items-start gap-5">
          <li>
            កម្លាំងឌីប៉ូល-ឌីប៉ូល កេីតឡេីងរវាងប៉ូលវិជ្ជមាននៃម៉ូលេគុលមួយ
            ជាមួយប៉ូលអវិជ្ជមាននៃម៉ូលេគុលមួយទៀត។
          </li>
          <li>ម៉ូលេគុលកាន់តែធំ កម្លាំងឌីប៉ូល-ឌីប៉ូលកាន់តែខ្លាំង។</li>
          <li>
            កាលណាកម្លាំងឌីប៉ូល-ឌីប៉ូលកាន់តែខ្លាំង
            នោះចំណុចរលាយនិងចំណុចរំពុះនៃសមាសធាតុកាន់តែខ្ពស់។
          </li>
          <li>
            កម្លាំងឌីប៉ូល-ឌីប៉ូលធំជាងកម្លាំងរបាយឡុនដុន។ គេអាចហៅថា
            កម្លាំងរបាយឡុនដុនថាជាកម្លាំង ឌីប៉ូលអន្ទង។
          </li>
        </ul>
      </>
    ),
...
const SixthTopicContent: TopicContent = {
  definition: {
    ...
    content: (
      <>
        <div className="flex flex-col items-start">
          <p>
            សម្ព័ន្ធអុីដ្រូសែនគឺជាកម្លាំងអន្តរម៉ូលេគុលកេីតឡេីងរវាងអាតូមអុីដ្រូសែនក្នុងម៉ូលេគុលមួយ
            ជាមួយអាតូមមួយ
            ក្នុងម៉ូលេគុលផ្សេងទៀតដែលមានកម្រិតអេឡិចត្រូអវិជ្ជមានធំ(មានធាតុ N, O,
            F) ។
          </p>
        </div>
      </>
  ...
  example2: {
    question: [
      <div className="flex flex-col items-start gap-3" key="q1">
        <p>
          ចូរកំណត់កម្លាំងអន្តរម៉ូលេគុលនិងសម្ព័ន្ធអុីដ្រូសែន
        ...
        content: (
          <div>
            <div className="flex flex-col items-start gap-3">
              ...
              <p>
                ដូចនេះរវាងកម្លាំងម៉ូលេគុលទាំងពីរជាកម្លាំងឌីប៉ូល-ឌីប៉ូល
                ហេីយវាក៏មានកម្លាំងឡុនដុនផងដែរ។
              </p>
            </div>
          </div>
        ),
        ...
        content: (
          <div>
            <div className="flex flex-col items-start gap-3">
              ...
              <p>
                ដូចនេះរវាងកម្លាំងម៉ូលេគុលទាំងពីរជាកម្លាំងឌីប៉ូល-ឌីប៉ូល
                ហេីយវាក៏មានសម្ព័ន្ធអុីដ្រូសែនផងដែរ។
              </p>
            </div>
          </div>
        ),
      ...
      <div>
        ...
        {SixthTopicContent.example && (
          <ExampleBox
            ...
            answer={SixthTopicContent.example.answer}
          />
        )}
        {SixthTopicContent.example2 && (
          <ExampleBox
            question={SixthTopicContent.example2.question}
            steps={SixthTopicContent.example2.steps}
            answer={SixthTopicContent.example2.answer}
          />
        )}
      </div>
    </div>
