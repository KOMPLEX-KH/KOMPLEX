  ...
  tip: {
    ...
    content: (
      <>
        <div className="flex items-start gap-3 flex-col">
          <p>
            ខ្លាញ់ និងប្រេងមានច្រេីននៅក្នុងធម្មជាតិ
            វាបង្កសំខាន់នៅក្នុងកោសិកាសត្វនិងរុក្ខជាតិ ។ ខ្លាញ់បានពីសត្វ
            ហេីយប្រេងបានពីរុក្ខជាតិ​ ។
          </p>
        </div>
      </>
    ),
  ...
  tip: {
    ...
    content: (
      <>
        <div className="flex items-start gap-3 flex-col">
          <p>
            ខ្លាញ់ និងប្រេងស្រាលជាងទឹក មិនរលាយក្នុងទឹក តែរលាយក្នុងឌីក្លរ៉ូអេតាន
            អេទែបង់សែន ប្រេងសាំង កាបូតេត្រាក្លរួ ឌីក្លរ៉ូអេទីឡែន ។
          </p>
        </div>
      </>
    ),
  ...
  tip: {
    ...
    content: (
      <>
        <div className="flex items-start gap-3 flex-col">
          <p>
            នៅពេលគេដុតកម្តៅទ្រីគ្លីសេរីតជាមួយបាស
            គេបានគ្លីសេរុលនិងអំបិលនៃអាសុីតខ្លាញ់ ។
          </p>
          <span className="text-[13px]">
    ...
    <div>
      ...
      <div>
        ...
        {SixthTopicContent.threeDExplanation &&
          ...
          SixthTopicContent.threeDExplanation.map(
        ...
        {SixthTopicContent.imageExplanation &&
          ...
          SixthTopicContent.imageExplanation.map(
      ...
      <div>
        ...
        {ThirdTeenthTopicContent.imageExplanation &&
          ...
          ThirdTeenthTopicContent.imageExplanation.map(
            (image: ImageBoxProps, index: number) => (
              <ImageExplanationBox
                key={index}
                title={image.title}
      ...
      <div>
        ...
        {FourthTeenTopicContent.tip && (
          <TipBox
            title={FourthTeenTopicContent.tip.title}
            content={FourthTeenTopicContent.tip.content}
          />
        )}
      </div>
      <div>
