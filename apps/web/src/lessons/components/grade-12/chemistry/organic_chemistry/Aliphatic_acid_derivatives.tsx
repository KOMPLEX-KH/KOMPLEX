    ...
    content: (
      <>
        <div className="flex flex-col items-start">
          <p>
            អាមីន ជាសមាសធាតុសរីរាង្គ ដែលបានពីការជំនួសអាតូមអុីដ្រូសែនរបស់ម៉ូលេគុល{" "}
            <InlineMath math="NH_{3}" /> ដោយរ៉ាឌីកាល់ <InlineMath math="R" />។
          </p>
        </div>
      </>
    ),
      ...
      <>
        <div className="flex flex-col items-start gap-3">
          ...
          <div className="flex items-center gap-5 flex-wrap">
            <p>
              <InlineMath math="R-NH_{2}" /> ជាអាមីន
            </p>
            <p>
              <InlineMath math="NH_{3}" /> ជាអាម៉ូញ៉ាក
            </p>
          </div>
          <p>
            R ជារ៉ាឌីកាល់អុីដ្រូកាបួខ្សែបេីក ។ បេី R
            ជារ៉ាឌីកាល់អុីដ្រូកាបួឆ្អែតគេបានរូបមន្តទូទៅ{" "}
            <span className="text-[13px]">
              <InlineMath math="C_{n}H_{2n+1^{-}}NH_{2}" />
            </span>{" "}
            ឬ{" "}
            <span className="text-[13px]">
              <InlineMath math="C_{n}H_{2n+3}N" />
            </span>
          </p>
        </div>
      </>
    ...
    content: (
      <>
        <div className="flex items-start gap-3 flex-col">
          <p>
            គេចែកអាមីនជាបីថ្នាក់ទៅតាមចំនួនអាតូមអុីដ្រូសែនរបស់អាម៉ូញ៉ាកដែលត្រូវជំនួសដោយរ៉ាឌីកាល់
            R ។
          </p>
    ...
    content: (
      <>
        <ul className="list-disc pl-5 flex flex-col items-start gap-4">
          <div>
            <li>
              អាមីនថ្នាក់ទីI ហៅឈ្មោះរ៉ាឌីកាល់ (R) រួចបន្ថែមបច្ឆឹមបទ អាមីន ។
            </li>
          </div>
          <div>
            <li>អាមីនថ្នាក់ទីII អាមីនថ្នាក់ទីIII</li>
            <p>
              ទី១ ហៅឈ្មោះរ៉ាឌីកាល់ (R) ដែលមានកាបូនខ្សែខ្លីដោយបញ្ជាក់ទីតាំង N- (
              ឬ N,N- ក្នុងករណីមានរ៉ាឌីកាល់ពីរ ) ។
            </p>
            <p>
              ទី២ ហៅឈ្មោះដូចអាមីនថ្នាក់ទីI ចំពោះរ៉ាឌីកាល់ដែលមានខ្សែកាបូនវែង
              ឬសាំញុាំ ។
            </p>
          </div>
        </ul>
...
const FifthTopicContent: TopicContent = {
  ...
  tip: {
    ...
    content: (
      <>
        <p>
          អាមីនដែលមានភាពរូបជាឧស្ម័នមានក្លិនពុំសូវល្អ ព្រោះមានលាយអាម៉ូញាក់ ។
          អាមីនដែល មានម៉ាសម៉ូលធំមាន កាបូនពី ៦ ឡើងទៅ មិនរលាយក្នុងទឹកទេ
          ប៉ុន្តែរលាយក្នុងអង្គធាតុរំលាយ សរីរាង្គ ។
          អាមីនមានចំណុចរំពុះខ្ពស់ជាងអាល់កាន តែទាបជាងអាល់កុលដែលមានម៉ាសម៉ូល
          ប្រហែលគ្នា ។ ក្នុងចំណោមអីសូមែរបស់វា អាមីនថ្នាក់ទី ១
          មានចំណុចរំពុះខ្ពស់ជាងគេ ហើយ អាមីនថ្នាក់ III ទាបជាងគេ ។
        </p>
      </>
    ),
  },
        ...
        <ul className="list-disc pl-5 flex flex-col items-start gap-4">
          <div className="flex items-start flex-col">
            ...
            <p>
              ...
              មានលក្ខណៈជាបាស ហេីយអាសុីតឆ្លាស់របស់វាគឺ{" "}
              <span className="text-[13px]">
                <InlineMath math="NH_{4}^{+}" />
              </span>{" "}
              ។ វាបង្កេីតបានជាគូអាសុីត-បាស{" "}
              <span className="text-[13px]">
          ...
          <div className="flex items-start flex-col">
            ...
            <p>
              អេទីលឡាមីន{" "}
              <span className="text-[13px]">
                <InlineMath math="C_{2}H_{5}-NH_{2}" />
              </span>{" "}
              រលាយក្នុងទឹក បង្កេីតជាសូលុយស្យុងបាស ។ កំហាប់ 0.1M មាន​ pH= 11.9 នៅ
              25°C ។ ដូចនេះ អេទីលឡាមីនជាបាសខ្សោយ ។
            </p>
            <span className="text-[13px]">
      ...
      <>
        <ul className="list-disc pl-5 flex flex-col items-start gap-4">
          <div className="flex flex-col items-start gap-2">
            ...
            <p>
              អាមីនថ្នាក់ទី I កកេីតធ្វេីប្រតិកម្មជាមួយ R-X បង្កេីតអាមីនថ្នាក់ទី
              II , អាមីនថ្នាក់ទី II ក៏ធ្វេីប្រតិកម្មជាមួយ R-X
              បង្កេីតអាមីនថ្នាក់ទី III ។ អាមីនថ្នាក់ទី III
              ក៏ធ្វេីប្រតិកម្មបន្តបង្កេីតជាអំបិលអាម៉ូញ៉ូម ។
            </p>
            <p>
              {" "}
              <span className="text-[13px]">
            ...
            <p>
              <span className="text-[13px]">
                <InlineMath math="R-NH_{2} + R-X \rightarrow R-NH-R + HX" />
              </span>{" "}
              (អាមីនថ្នាក់ទី II)
            </p>
            <p>
              <span className="text-[13px]">
                <InlineMath math="R-NH-R + R-X \rightarrow R_{3}N + HX" />
              </span>{" "}
              (អាមីនថ្នាក់ទី III)
            </p>
            <p>
              <span className="text-[13px]">
                <InlineMath math="R_{3}N + R-X \rightarrow R_{4}NX" />
              </span>{" "}
              (អំបិលអាម៉ូញ៉ូម)
            </p>
          </div>
  ...
  definition: {
    ...
    content: (
      <>
        <div className="flex flex-col items-start">
          <p>
            អាមីត គឺជាស្រឡាយនៃអាសុីតកាបុកសុីលិច (R-COOH) ដែលក្នុងនោះបង្គុំ (-OH)
            របស់អាសុីតត្រូវបានជំនួសដោយបង្គុំអាមីន{" "}
            <span className="text-[13px]">
    ...
    content: (
      <>
        <div className="flex flex-col items-start gap-3">
          ...
          <p>
            អាតូមអុីដ្រូសែនរបស់បង្គុំ{" "}
            <span className="text-[13px]">
              <InlineMath math="(-NH_{2})" />
            </span>{" "}
            ត្រូវបានជំនួសដោយរ៉ាឌីកាល់អុីដ្រូកាបួ បង្កេីតជាថ្នាក់អាមីត ។
          </p>
          <div className="flex items-center gap-2 ">
            <span className="text-[13px]">
              <InlineMath math="R-CO-NH_{2}" />
    ...
    content: (
      <>
        <ul className="list-disc pl-5 flex flex-col items-start gap-4">
          <div className="flex items-start gap-3 flex-col">
            <li>
              ឈ្មោះរបស់អាមីតបានមកពីឈ្មោះអាសុីតដោយប្តូរបច្ឆឹមបទ
              អូអុីចរបស់អាសុីតទៅជាអាមីត ។
            </li>
            <p>
              {" "}
              <span className="text-[13px]">
                <InlineMath math="H-CO-NH_{2}" />
              </span>{" "}
              មេតាណាមីត
            </p>
            <p>
              <span className="text-[13px]">
                <InlineMath math="CH_{3}-CO-NH_{2}" />
              </span>{" "}
              អេតាណាមីត
            </p>
          </div>
          <div className="flex items-start gap-3 flex-col">
            <li>
              ដេីម្បីហៅឈ្មោះអាមីតថ្នាក់ទី II និង III
              គេត្រូវហៅរ៉ាឌីកាល់កាបួដោយបញ្ជាក់ទីតាំង
            </li>
            <p>
              <span className="text-[13px]">
                <InlineMath math="CH_{3}-CO-NH-CH_{3}" />
              </span>{" "}
              N-មេទីល អេតាណាមីត
            </p>
            <div className="flex items-start gap-2 ">
...
const EleventhTopicContent: TopicContent = {
  ...
  tip: {
    ...
    content: (
      <>
        <p>
          អាមីតមានចំណុចរំពុះខ្ពស់ ។ អាមីតភាគច្រើនមានទម្រង់ជាក្រាមរឹង។
          អាមីតរលាយក្នុង ទឹកបានច្រើនជាងអាល់កុលបន្តិច ដោយដុតកម្ដៅជាមួយទឹក
          និងអាម៉ូញាក់។ កាលណាម៉ូលេគុលទាំងពីរមានចំនួនអាតូមកាបួនស្មើគ្នា។
          អាមីតរងអីដ្រូលីសយឺតៗបង្កើតបានជាអាស៊ីតកាបុកស៊ីលិចនិងអាម៉ូញាក់ ។
        </p>
        <span className="text-[13px]">
    ...
    content: (
      <>
        <div className="flex flex-col items-start gap-3">
          <p>
            <span className="text-[13px]">
              <InlineMath math="H_{2}CO_{3}" />
            </span>{" "}
            អាសុីតកាបូនិច
          </p>
          <p>
            <span className="text-[13px]">
              <InlineMath math="H_{2}N-CO-NH_{2}" />
            </span>{" "}
            អ៊ុយរ៉េ
          </p>
          <p>
            ទង្វេី{" "}
            <span className="text-[13px]">
              <InlineMath math="CO_{2} + 2NH_{3} \rightarrow H_{2}N-CO-NH_{2} + H_{2}O" />
            </span>
          </p>
        </div>
      </>
  ...
  definition: {
    ...
    content: (
      <>
        <div className="flex flex-col items-start">
          <p>
            អាសុីតអាមីណេ គឺជាសមាសធាតុសរីរាង្គដែលមានបង្គំកាបុកសុីល{" "}
            <span className="text-[13px]">
              <InlineMath math="(-COOH)" />
            </span>{" "}
            មួយនិងបង្គុំអាមីន{" "}
            <span className="text-[13px]">
              <InlineMath math="(-NH_{2})" />
            </span>{" "}
            មួយ។ កាលណាបង្គុំទាំងពីរភ្ជាប់នឹងកាបូនតែមួយ គេបានអាសុីត{" "}
            <span className="text-[13px]">
  ...
  tip: {
    ...
    content: (
      <>
        <div className="flex items-start gap-3 flex-col">
          <p>
            គេហៅអាសុីតអាមីណេតាមឈ្មោះធ្លាប់ប្រេី ។
            កាលណាបង្គុំអាមីនជាប់នឹងអាតូមកាបូនក្នុងទីតាំង
            <InlineMath math="\beta" /> ឈ្មោះអាសុីតអាមីណេត្រូវបន្ថែមបុព្វបទ
            <InlineMath math="\beta" />
            -អាមីណូ ទៅលេីឈ្មោះអាសុីតកាបុកសុីលិច ។
          </p>
          <div className="flex items-start gap-3 flex-wrap">
            <div className="flex items-start text-[13px]">
              <InlineMath math="H-" />
    ...
    content: (
      <>
        <ul className="list-disc pl-5 flex flex-col items-start gap-4">
          <div>
            <li>
              អាស៊ីតអាមីណេ គឺជាអង្គធាតុក្រាមដែលរលាយ ឬបំបែកនៅសីតុណ្ហភាពខ្ពស់ ។
              ប៉ុន្តែមិនរលាយក្នុងអង្គធាតុរំលាយសរីរាង្គ ដូចជា
              បង់សែនវាងាយរលាយក្នុងទឹកអាល់កុល អេទែ... ទេ។
            </li>
          </div>
          <div className="flex flex-col gap-3">
            <li>
              ក្នុងម៉ូលេគុលអាស៊ីតអាមីណេ បង្គុំកាបុកស៊ីលមានលក្ខណៈជាអាស៊ីត
              ឯបង្គំអាមីនមានលក្ខណៈជាបាស ។
            </li>
          ...
          <div>
            <li>
              អាសុីតអាមីណេ មានលក្ខណៈអំផូទែគឺវាអាចចាប់យកប្រូតុងពីអាសុីតខ្លាំង
              ឬផ្តល់ប្រូតុងទៅបាសខ្លាំង ។
            </li>
          </div>
        </ul>
      </>
      ...
      <>
        ...
        <ul className="list-disc pl-5 flex flex-col items-start gap-4">
          <div>
            <li>
              គេឲ្យអាស៊ីត
              <InlineMath math="\alpha" /> អាឡូសែណូកាបុកស៊ីលិច
              មានប្រតិកម្មជាមួយអាម៉ូញាក់ គេទទួលបានអាស៊ីត
              <InlineMath math="\alpha" />
              -អាមីណូកាបុកស៊ីលិច ។{" "}
            </li>
            <div className="flex items-start gap-3">
          ...
          <div>
            <li>
              គេឲ្យអាល់ដេអុីតមានអំពើជាមួយអ៊ីដ្រូសែនស្សានួ ចំពោះវត្តមានអាម៉ូញាក់
              បង្កើតបានជាអាមីណូនីទ្រីល ។
              អ៊ីដ្រូលីសអាមីណូនីទ្រីលផ្តល់អាស៊ីតអាមីណេ ។
            </li>
          </div>
        </ul>
      </>
...
const TwentyTopicContent: TopicContent = {
  ...
  tip: {
    ...
    content: (
      <>
        <p>
          សម្ព័ន្ធប៉ិបទីត (-CO-NH-)
          កើតឡើងដោយម៉ូលេគុលអាស៊ីតអាមីណេចំនួនពីរភ្ជាប់គ្នាដោយការដកទឹកចេញចំនួន ១
          ម៉ូលេគុល។
        </p>
        ...
        <ul className="list-disc pl-5 flex flex-col items-start gap-4">
          <li>
            ប៉ិបទីតដែលបង្កដោយអាស៊ីតអាមីណេចំនួន ៣, ៤ ឬ ៥ មានឈ្មោះថា
            ទ្រីប៉ិបទីតតេត្រាប៉ិបទីត ប៉ង់តាប៉ិបទីត។
          </li>
          ...
          <li>
            ប្រូតេអ៊ីនធម្មជាតិផ្តល់អាស៊ីតអាមីណេចំនួន 20 ប្រភេទដែលក្នុងនោះមាន
            អាស៊ីតអាមីណេចំនួន ៨
            ដែលមនុស្សត្រូវផ្តល់ឲ្យសារពាង្គកាយមិនអាចខ្វះបានតាមរយៈអាហារព្រោះសរីរាង្គមនុស្សមិនអាចសំយោគវាបាន។
          </li>
          <li>
            អាស៊ីតអាមីណេចំនួន៨ដែលសំខាន់សម្រាប់សារពាង្គកាយរួមមាន៖ វ៉ាលីន
            ឡឺស៊ីនអ៊ីសូឡឺស៊ីន ត្រេអូនីន មេត្យូនីន លីស៊ីន ផេនីឡាមីន និង
            ទ្រីបតូផាន។
          </li>
        </ul>
      </>
    ...
    <div>
      ...
      <div>
        {FourthTeenTopicContent.definition && (
          <DefinitionBox
            title={FourthTeenTopicContent.definition.title}
            content={FourthTeenTopicContent.definition.content}
          />
        )}
      </div>
      <div>
        {FifthTeenTopicContent.definition && (
          <DefinitionBox
            title={FifthTeenTopicContent.definition.title}
            content={FifthTeenTopicContent.definition.content}
          />
        )}
        {FifthTeenTopicContent.tip && (
          <TipBox
            title={FifthTeenTopicContent.tip.title}
            content={FifthTeenTopicContent.tip.content}
          />
        )}
      </div>
      <div>
        {SixteenthTopicContent.definition && (
          <DefinitionBox
            title={SixteenthTopicContent.definition.title}
            content={SixteenthTopicContent.definition.content}
          />
        )}
        {SixteenthTopicContent.tip && (
          <TipBox
            title={SixteenthTopicContent.tip.title}
            content={SixteenthTopicContent.tip.content}
          />
        )}
      </div>
      <div>
        {SeventeenthTopicContent.definition && (
          <DefinitionBox
            title={SeventeenthTopicContent.definition.title}
            content={SeventeenthTopicContent.definition.content}
          />
        )}
        {SeventeenthTopicContent.tip && (
          <TipBox
            title={SeventeenthTopicContent.tip.title}
            content={SeventeenthTopicContent.tip.content}
          />
        )}
      </div>
      <div>
        {EighteenthTopicContent.definition && (
          <DefinitionBox
            title={EighteenthTopicContent.definition.title}
            content={EighteenthTopicContent.definition.content}
          />
        )}
        {EighteenthTopicContent.tip && (
          <TipBox
            title={EighteenthTopicContent.tip.title}
            content={EighteenthTopicContent.tip.content}
          />
        )}
      </div>
      <div>
        {NineteenthTopicContent.definition && (
          <DefinitionBox
            title={NineteenthTopicContent.definition.title}
            content={NineteenthTopicContent.definition.content}
          />
        )}
      </div>
      <div>
        {TwentyTopicContent.definition && (
          <DefinitionBox
            title={TwentyTopicContent.definition.title}
            content={TwentyTopicContent.definition.content}
          />
        )}
        {TwentyTopicContent.tip && (
          <TipBox
            title={TwentyTopicContent.tip.title}
            content={TwentyTopicContent.tip.content}
          />
        )}
      </div>
    </div>
