...
const FirstTopicContent: TopicContent = {
  definition: {
    ...
    content:
      "សមីការឌីផែរ៉ង់ស្សែលលីនេអែអូម៉ូសែនលំដាប់ទី1មានមេគុណថេរគឺគ្រប់សមីការដែលមានទម្រង់ y' - ay = 0 ,a ជាចំនួនថេរ​។",
  },
  tip: {
    title: "ជាទូទៅ",
    content: (
      <>
        <p>
          សមីការឌីផែរ៉ង់ស្សែល <InlineMath math="y' - ay = 0" />{" "}
          មានចម្លើយទូទៅដូចខាងក្រោម៖
        </p>
        <BlockMath math="y = Ke^{ax}" />
        <p>
          ដែល <InlineMath math="K \in \mathbb{R}" /> ហើយ <InlineMath math="a" />{" "}
          ជាចំនួនថេរ។
        </p>
      </>
    ),
    ...
    answer: (
      <div>
        <div className="justify-center items-center flex flex-col">
          <p>
            <InlineMath math="y = Ke^{6x}" />
          </p>
          <p>
            <InlineMath math="y = Ke^{\frac{4}{\sqrt{5}}x}" />
          </p>
        </div>
  ...
  warning: {
    content: (
      <>
        <p>
          សូមប្រុងប្រយ័ត្ន ចំពោះសញ្ញា <InlineMath math={"a"} />{" "}
          ត្រូវតែត្រឹមត្រូវ ដូចជាសមីការ <InlineMath math={"y' + 5y = 0"} /> គឺ{" "}
          <InlineMath math={"a = -5"} />, មិនមែន 5 ទេ។
        </p>
        <p>
          កុំភ្លេចបញ្ចូលចំនួនថេរ <InlineMath math={"K"} />{" "}
          នៅក្នុងចម្លើយទូទៅផងដែរ។
        </p>
      </>
    ),
  },
  ...
  definition: {
    ...
    content: (
      <>
        ...
        <InlineMath math={"y' + ay = P(x) \\quad (E)"} />, ដែល P(x) ​ខុសពី 0
      </>
    ),
  },
  tip: {
    ...
    content: (
      <div className="flex flex-col gap-5 mt-4">
        <ul className="list-disc pl-3">
          <h3 className="font-bold flex items-center gap-2">របៀបទីមួយ</h3>
          <li>
        ...
        <ul className="list-disc pl-3">
          ...
          <li>
            ត្រូវរកចម្លើយទូទៅនៃសមីការ <InlineMath math={"y' - ay = 0"} />{" "}
            ដែលតាងដោយ <InlineMath math={"y_c = Ke^{ax}"} />។
          </li>
          <li>
            ក្នុងចម្លើយទូទៅខាងលើនេះ យក K ជាអនុគមន៍នៃ x នោះចម្លើយនៃសមីការ{" "}
            <InlineMath math={"y' - ay = P(x)"} /> គឺ{" "}
            <InlineMath math={"y_c = K(x)e^{ax}"} />។
          </li>
          <li>
            គណនា <InlineMath math={"y'"} /> រួចយក <InlineMath math={"y"} /> និង{" "}
            <InlineMath math={"y'"} /> ទៅជំនួសក្នុងសមីការដើម ហើយទាញរក{" "}
            <InlineMath math={"K(x)"} />។
          </li>
        </ul>
      </div>
      ...
      <div>
        ...
        {SecondTopicContent.example && (
          <ExampleBox
            ...
            answer={SecondTopicContent.example.answer}
          />
        )}
        {SecondTopicContent.example2 && (
          <ExampleBox
            question={SecondTopicContent.example2.question}
            steps={SecondTopicContent.example2.steps}
            answer={SecondTopicContent.example2.answer}
          />
        )}
