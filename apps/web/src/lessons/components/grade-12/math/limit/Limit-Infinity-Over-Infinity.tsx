...
const content: TopicContent_V3[] = [
  ...
  },
  {
    ...
    content: (
      <div className="text-left">ដើម្បីគណនាលីមីតនេះ យើងធ្វើដូចខាងក្រោម:</div>
    ),
    steps: [
      {
    ...
    questions: [
      {
        ...
        question: (
          <div className="text-left">
            គណនា{" "}
            <InlineMath math="lim_{x \to \infty} \frac{2x^2 + x - 3}{x^2 + 4}" />
          </div>
        ),
        options: ["0", "2", "1", "∞"],
        correctAnswer: 1,
      ...
      },
      {
        ...
        question: (
          <div className="text-left">
            គណនា <InlineMath math="lim_{x \to \infty} \frac{x^2 + 3}{x - 5}" />
          </div>
        ),
        options: ["∞", "0", "1", "3"],
        correctAnswer: 0,
      ...
      },
      {
        ...
        question: (
          <div className="text-left">
            គណនា{" "}
            <InlineMath math="lim_{x \to \infty} \frac{5x + 2}{3x^2 + x - 1}" />
          </div>
        ),
        options: ["0", "5/3", "∞", "1"],
        correctAnswer: 0,
      ...
      },
      {
        ...
        question: (
          <div className="text-left">
            គណនា{" "}
            <InlineMath math="lim_{x \to \infty} \frac{\sqrt{x^2 + 1}}{x + 2}" />
          </div>
        ),
        options: ["1", "0", "∞", "1/2"],
        correctAnswer: 0,
