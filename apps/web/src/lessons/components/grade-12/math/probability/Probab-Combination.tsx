...
const FirstTopicContent: TopicContent = {
  ...
  example2: {
    ...
    steps: [
        ...
        content: (
          <div>
            ...
            <div className="flex items-center gap-2 justify-start flex-wrap">
              <BlockMath
                math={"\\Rightarrow n(s)= C(19,3) = \\frac{19!}{3!(19-3)!}"}
              />
              <BlockMath math={"= 969"} />
              <p>ករណី</p>
            </div>
      ...
      {
        title:
          "គ. រកប្រូបាបព្រឹត្តការណ៍ដែលជ្រេីសរេីសបានប្រុស ២នាក់ និងសិស្សស្រី ១នាក់",
        content: (
          <div>
            <div className="flex flex-col gap-3">
              <p>
                តាង C ជាព្រឹត្តការណ៍ដែលជ្រេីសរេីសបានប្រុស ២នាក់ និងសិស្សស្រី
                ១នាក់
              </p>
              <p>
            ...
            <div className="flex items-center gap-2 justify-center">
              <div className="flex items-center justify-start gap-2 flex-wrap w-full">
                ...
                <BlockMath
                  math={" \\frac{8!}{1!(8-1)!} * \\frac{11!}{2!(11-2)!}= 440"}
                />
              </div>
              {/* <p>ករណី</p> */}
            </div>
            <div className="flex flex-col items-start">
              ...
              <BlockMath
                math={"P(C) = \\frac{n(C)}{n(s)} = \\frac{440}{969}"}
              />
            </div>
          </div>
        ),
