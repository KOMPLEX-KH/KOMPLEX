...
const content: TopicContent_V3[] = [
    ...
    explanation: (
      <>
        <div>
          ...
          (V: មាឌ, ខ្នាតគិតជា <InlineMath math="cm^3" />)<br />
          <b>ឬគេអាចរកតាម:</b>
    ...
    content: (
      <>
        <ul>
          ...
          <li>
            គណនាផលគុណវ៉ិចទ័រកាត់ (cross product) និងផលគុណស្កាលែរ (scalar product) តាមលំដាប់។
          </li>
          <li>
      ...
      },
      {
        ...
        content: (
          <>
            ...
            <br />
            <InlineMath
              math={String.raw` = (1,2,3) \times (2,0,1)`}
            /> <br />
  ...
  },
  {
    ...
    explanation: (<div>
      ...
      />{" "}
      <br />
      (V: មាឌ, ខ្នាតគិតជា <InlineMath math="cm^3" />)
    </div>)
  },
  {
    type: "hint",
    ...
    steps: [
      {
        ...
        content: (
          <>
            ...
            នាំឲ៖ <br />
            <InlineMath
              math={"\\overrightarrow{AB} = (2,1,3)"}
            /> <br />
            <InlineMath
              math={"\\overrightarrow{AD} = (1,2,0)"}
            /> <br />
            <InlineMath
              math={"\\overrightarrow{AE} = (0,1,2)"}
            /> <br />
          </>
        ),
      },
      {
        ...
        content: (
          <>
            ...
            <br />
            <InlineMath
              math={String.raw`= (1,2,0) \times (0,1,2)`}
            /> <br />
      ...
      },
      {
        ...
        content: (
          <>
            ...
            <br />
            <InlineMath
              math={String.raw`= (2,1,3) \cdot (4,-2,1)`}
            /> <br />
            <InlineMath
