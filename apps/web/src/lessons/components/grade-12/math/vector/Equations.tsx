...
const TOPIC_CONTENT_PLANE = {
  definition: {
    ...
    hint: {
      content: (
        <div className="ml-2">
          • វ៉ិចទ័រណរម៉ាល់ ​ឬ វ៉ិចទ័រកែង{" "}
          <InlineMath math={"\\vec{n} = (a, b, c)"} />។ <br />
          ...
          និងវ៉ិចទ័រប្រាប់ទិស <InlineMath math={"\\vec{n} = (a, b, c)"} />។{" "}
          <br />• សមីការប្លង់ទូទៅអាចបង្ហាញពីទិសដៅនៃប្លង់បាន។
        </div>
      ),
    },
  },
...
const TOPIC_CONTENT_SPHERICAL = {
          ...
          <ImageExplanationBox
            ...
            explanation={
              <>
                ...
                <br />
                <b>ដែល</b>{" "}
                <BlockMath math={"k = x_0^2 + y_0^2 + z_0^2 - r^2"} />
              </>
            }
          />
        </>
    ...
    hint: {
      content: (
        <div className="ml-2">
          ...
          <InlineMath math={"r"} />។ <br />• ពាក្យ x<sup>2</sup>, y<sup>2</sup>,
          និង z<sup>2</sup> ត្រូវតែមានមេគុណស្មើគ្នា និងជាវិជ្ជមាន (ជាទូទៅគឺ 1)។{" "}
          <br />
  ...
  example: {
    question: <>រកសមីការស្វ៊ែ S ដែលមានផ្ចិត I(1, 2, 3) និងមានកាំ r = 4។</>,
    steps: [
      {
        title: "រកសមីការស្វ៊ែ",
        content: (
...
const TOPIC_CONTENT_DISTANCE_BETWEEN_POINTS = {
    ...
    tip: {
      content: (
        <>
          ...
          បើបន្ទាត់​​ <InlineMath math={"L"} /> ស្របនឹងវិចទ័រ​{" "}
  ...
  example: {
    question: <>រកចម្ងាយពីចំណុច A(1, 2, 3) ទៅប្លង់ P: 2x - 3y + z + 4 = 0។</>,
    steps: [
      {
  ...
  return (
    <div>
      ...
      {TOPIC_CONTENT_PLANE.definition && (
        <DefinitionBox
          title={TOPIC_CONTENT_PLANE.definition.title}
          content={TOPIC_CONTENT_PLANE.definition.content}
        />
      )}
      ...
      {TOPIC_CONTENT_SPHERICAL.definition && (
        <DefinitionBox
          title={TOPIC_CONTENT_SPHERICAL.definition.title}
          content={TOPIC_CONTENT_SPHERICAL.definition.content}
        />
      )}
      ...
      {TOPIC_CONTENT_DISTANCE_BETWEEN_POINTS.definition && (
        <DefinitionBox
          title={TOPIC_CONTENT_DISTANCE_BETWEEN_POINTS.definition.title}
          content={TOPIC_CONTENT_DISTANCE_BETWEEN_POINTS.definition.content}
        />
      )}
      {TOPIC_CONTENT_DISTANCE_BETWEEN_POINTS.definition?.tip && (
        <TipBox
          content={TOPIC_CONTENT_DISTANCE_BETWEEN_POINTS.definition.tip.content}
        />
      )}
      {TOPIC_CONTENT_DISTANCE_BETWEEN_POINTS.definition?.hint && (
        <HintBox
          content={
            TOPIC_CONTENT_DISTANCE_BETWEEN_POINTS.definition.hint.content
          }
        />
      )}
