...
const TOPIC_CONTENT_V3: TopicContent_V3[] = [
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="bg-gray-50 p-4 rounded-lg">
                            ...
                            <div className="space-y-3 mt-2">
                                ...
                                <p>ដូច្នេះ៖ <InlineMath math="a = 4, b = 3, c = \sqrt{a^2 + b^2} = 5" /></p>
                                <div className="border-l-4 border-blue-400 pl-4 space-y-2">
                                    <p>• ចំណុចកណ្តាល៖ <InlineMath math="(3, 1)" /></p>
                                    <p>• កំពូល៖ <InlineMath math="(7, 1), (-1, 1)" /></p>
                                    <p>• កំណុំ៖ <InlineMath math="(8, 1), (-2, 1)" /></p>
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="bg-gray-50 p-4 rounded-lg">
                            ...
                            <div className="space-y-3 mt-2">
                                ...
                                <p>រកតម្លៃ b៖ <InlineMath math="c^2 = a^2 + b^2 \Rightarrow b^2 = 16" /></p>
    ...
    },
    {
        ...
        questions: [
            {
                id: "1",
                question: <>កំពូលនៃអុីពែបូល <InlineMath math="\frac {(x-2)^2}{9} - \frac{(y+3)^2}{16} = 1" /> គឺ៖</>,
            ...
            {
                id: "3",
                question: <>អាស៊ីមតូតនៃអុីពែបូល <InlineMath math=" \frac {x^2}{4} - \frac {y^2}{9} = 1" /> គឺ៖</>,
                options: [
