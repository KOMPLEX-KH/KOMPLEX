...
//           • បន្ទាត់ <InlineMath math="\Delta" /> ហៅថា{" "}
//           <strong>បន្ទាត់ប្រាប់ទិស​</strong> <br />
//           • ចំណុច <InlineMath math="V(h,k)" /> ហៅថា{" "}
//           <strong>កំពូលប៉ារ៉ាបូល​</strong> <br />
//           • បន្ទាត់ <InlineMath math="x = h" /> ហៅថា{" "}
//           <strong>អ័ក្សសមស្មើ​</strong> <br />
//         </div>
//       ),
//     },
//     tip: {
...
//                     <li>
//                       • សមីការគ្រឹះ៖ <InlineMath math="y^2 = 4px" />
//                     </li>
//                     <li>
//                       • កំពូល <InlineMath math="V(0,0)" />
//                     </li>
//                     <li>
//                       • កំណុំ <InlineMath math="F(p,0)" />
//                     </li>
//                     <li>
//                       • បន្ទាត់ប្រាប់ទិស <InlineMath math="x = -p" />
//                     </li>
//                     <li>
//                       • <InlineMath math="p > 0" /> ប៉ារ៉ាបូលបើកទៅខាងស្ដាំ{" "}
//                       <InlineMath math="x > 0" />
//                     </li>
//                     <li>
//                       • <InlineMath math="p < 0" /> ប៉ារ៉ាបូលបើកទៅខាងឆ្វេង{" "}
//                       <InlineMath math="x < 0" />
//                     </li>
//                   </ul>
//                 </div>
...
//                   <ul className="space-y-2 text-sm">
//                     <li>
//                       • សមីការគ្រឹះ៖ <InlineMath math="x^2 = 4py" />
//                     </li>
//                     <li>
//                       • កំពូល <InlineMath math="V(0,0)" />
//                     </li>
//                     <li>
//                       • កំណុំ <InlineMath math="F(0,p)" />
//                     </li>
//                     <li>
//                       • បន្ទាត់ប្រាប់ទិស <InlineMath math="y = -p" />
//                     </li>
//                     <li>
//                       • <InlineMath math="p > 0" /> ប៉ារ៉ាបូលបើកឡើងលើ{" "}
//                       <InlineMath math="y > 0" />
//                     </li>
//                     <li>
//                       • <InlineMath math="p < 0" /> ប៉ារ៉ាបូលបើកចុះក្រោម{" "}
//                       <InlineMath math="y < 0" />
//                     </li>
//                   </ul>
//                 </div>
...
//                   <ul className="space-y-2 text-sm">
//                     <li>
//                       • សមីការគ្រឹះ៖ <InlineMath math="(y-k)^2 = 4p(x-h)" />
//                     </li>
//                     <li>
//                       • កំពូល <InlineMath math="V(h,k)" />
//                     </li>
//                     <li>
//                       • កំណុំ <InlineMath math="F(h+p,k)" />
//                     </li>
//                     <li>
//                       • បន្ទាត់ប្រាប់ទិស <InlineMath math="x = h-p" />
//                     </li>
//                     <li>
//                       • <InlineMath math="p > 0" /> ប៉ារ៉ាបូលបើកទៅខាងស្ដាំ{" "}
//                       <InlineMath math="x > 0" />
...
//                     <li>
//                       • សមីការទូទៅប៉ារ៉ាបូល៖{" "}
//                       <InlineMath math="By^2 + Cx + Dy + E = 0, B ≠ 0" />
//                     </li>
//                   </ul>
//                 </div>
...
//                   <ul className="space-y-2 text-sm">
//                     <li>
//                       • សមីការគ្រឹះ៖ <InlineMath math="(x-h)^2 = 4p(y-k)" />
//                     </li>
//                     <li>
//                       • កំពូល <InlineMath math="V(h,k)" />
//                     </li>
//                     <li>
//                       • កំណុំ <InlineMath math="F(h,k+p)" />
//                     </li>
//                     <li>
//                       • បន្ទាត់ប្រាប់ទិស <InlineMath math="y = k-p" />
//                     </li>
//                     <li>
//                       • <InlineMath math="p > 0" /> ​ប៉ារ៉ាបូលបើកឡើងលើ{" "}
//                       <InlineMath math="y > 0" />
...
//                     <li>
//                       • សមីការទូទៅប៉ារ៉ាបូល៖{" "}
//                       <InlineMath math="Ax^2 + Cx + Dy + E = 0, A ≠ 0" />
//                     </li>
//                   </ul>
//                 </div>
//               </div>
...
//                 <p>
//                   • ប៉ារ៉ាបូលឈរ៖ អថេរ <InlineMath math="y" /> ស្ថិតក្នុងការេ
//                 </p>
//                 <p>
//                   • ប៉ារ៉ាបូលដេក៖ អថេរ <InlineMath math="x" /> ស្ថិតក្នុងការេ
//                 </p>
//                 <p>
//                   • <InlineMath math="4p" /> កំណត់ទិសដៅនិងការបើកប៉ារ៉ាបូល
//                 </p>
//                 <p>
//                   • តម្លៃ p គឺជាចម្ងាយពីកំពូល (V) ទៅកំណុំ (F) និងពីកំពូល (V)
//                   ទៅបន្ទាត់ប្រាប់ទិស (Δ)។
//                 </p>
//               </div>
//             </div>
//           </div>
...
//                   </p>
//                   <p>
//                     យើងបាន៖ <InlineMath math="h = 3, k = 1, 4p = 8" />
//                   </p>
//                   <p>
//                     ដូច្នេះ៖ <InlineMath math="p = 2" />
//                   </p>
//                   <div className="border-l-4 border-blue-400 pl-4 space-y-2">
//                     <p>
//                       • កំពូល៖ <InlineMath math="V(3, 1)" />
//                     </p>
//                     <p>
//                       • កំណុំ៖ <InlineMath math="F(3, 1 + 2) = F(3, 3)" />
//                     </p>
//                     <p>
//                       • បន្ទាត់ប្រាប់ទិស៖ <InlineMath math="y = 1 - 2 = -1" />
//                     </p>
//                     <p>
//                       • អ័ក្សសមស្មើ៖ <InlineMath math="x = 3" />
//                     </p>
//                   </div>
//                 </div>
//               </div>
...
//             <div className="space-y-4">
//               <p>
//                 រកសមីការប៉ារ៉ាបូលដែលមានកំពូល <InlineMath math="V(1, -2)" />{" "}
//                 និងកំណុំ <InlineMath math="F(1, 0)" />
//               </p>
//               <div className="bg-gray-50 p-4 rounded-lg">
//                 <p className="font-medium">ដំណោះស្រាយ៖</p>
//                 <div className="space-y-3 mt-2">
//                   <p>
//                     កំពូល៖ <InlineMath math="V(h, k) = V(1, -2)" /> ដូច្នេះ{" "}
//                     <InlineMath math="h = 1, k = -2" />
//                   </p>
//                   <p>
//                     ចម្ងាយពីកំពូលទៅកំណុំ៖ <InlineMath math="p = 0 - (-2) = 2" />
//                   </p>
//                   <p>
//                     រូបមន្តទូទៅ៖ <InlineMath math="(x - h)^2 = 4p(y - k)" />
//                   </p>
...
//           • ចាំថា <InlineMath math="4p" /> នៅក្នុងរូបមន្ត មិនមែន{" "}
//           <InlineMath math="p" /> ទេ <br />
...
//           id: "2",
//           question:
//             "ប្រសិនបើប៉ារ៉ាបូលមានកំពូល (0,0) និងកំណុំ (0,3) សមីការរបស់វាគឺ៖",
...
//           question: (
//             <>
//               បន្ទាត់ប្រាប់ទិសនៃប៉ារ៉ាបូល <InlineMath math="x^2 = -8y" />
//               គឺ៖
//             </>
//           ),
