    ...
    content: (
      <>
        <ul className="list-disc flex flex-col gap-3 ml-4">
          <li>
            ប៉ិបទីត ជាបណ្តុំរវាងការភ្ជាប់អាស៊ីតអាមីនេពីរ ឬច្រើន តែមិនលើសពី១០។
          </li>
          <li>
            ចំណងប៉ិបទីត ជាសម្ព័ន្ធកូវ៉ាឡង់ដែលភ្ជាប់រវាងបណ្តុំកាបុកស៊ីល (-COOH)
            របស់អាស៊ីតអាមីនេមួយ ទៅនឹងអាមីន{" "}
            <span className="text-[13px]">
              <InlineMath math="NH_{2}" />
            </span>{" "}
            របស់អាស៊ីតអាមីនេមួយទៀត ដោយបាត់បង់មួយម៉ូលេគុលទឹក។
          </li>
          <li>
            តេត្រាបុិបទីត ប៉ង់តាបុិបទីត... ។ លេីសពី១០អាសុីតអាមីនេ
            ហៅថាប៉ូលីបុិបទីត ។
          </li>
        </ul>
      </>
