    ...
    content: (
      <>
        <ul className="list-disc ml-4 flex flex-col gap-3">
          ...
          <li>
            អាស៊ីតអាមីនេផ្សំឡើងពីធាតុគីមី៤គឺ C H O N ជួនកាលមានផូស្វាត
            និងស្ពាន់ធ័រ។
          </li>
          <li>
            ម៉ូលេគុលអាស៊ីតអាមីនេនីមួយៗផ្សំឡើងពីកាបូនកណ្តាលដោយភ្ជាប់អាតូមអមួយ
            បណ្ដុំកាបុកស៊ីល (-COOH) បណ្តុំអាមីន និងរ៉ាឌីកាល់ R ។
          </li>
          ...
          <li>
            នៅកម្រិត pH=7 បណ្ដុំកាបុកស៊ីលបំបែកទៅជាទម្រង់បាស{" "}
            <span className="text-[13px]">
              <InlineMath math="(COO^{-})" />
            </span>{" "}
            ហើយបណ្ដុំអាមីនបំបែកទៅជាទម្រង់អាស៊ីត{" "}
            <span className="text-[13px]">
  ...
  example: {
    question: [
      <ul className="flex flex-col items-start gap-3 list-disc pl-4" key="q1">
        <li>
          គ្លីស៊ីន អាស៊ីតគ្លុយតាមិច សេរ៉ូតូនីនក្លាយមកពី ទ្រីបតូហ្វាន
          វាជាអ្នកបញ្ជូនព័ត៌មានប្រសាទ ហើយមានឥទ្ធិពល ទៅលើនាទីរបស់កោសិកាគោលដៅ
          (ឬកោសិកាសាច់ដុំ)។
        </li>
        <li>
          ទីរ៉ុកស៊ីនអុីនដល និងអាស៊ីតអាសេទិចឬអុកស៊ីន
          មាននាទីសម្របសម្រួលនាទីកោសិកា។
        </li>
        <li>
          អាស៊ីនីន ស៊ីត្រុយលីន និងអ័រនីទីនមាននាទីដឹកនាំមេតាបូលីសក្នុងកោសិកា។
        </li>
      </ul>,
    ],
  },
