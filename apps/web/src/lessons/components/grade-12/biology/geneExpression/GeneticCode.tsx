    ...
    content: (
      <>
        <ul className="list-disc ml-4 flex flex-col gap-3">
          <li>
            ពីតំណលំដាប់នុយក្លេអូទីតនៃសែនទៅជាតំណលំដាប់អាស៊ីតអាមីនេនៃប្រូតេអ៊ីន
            ត្រូវមានអន្តរាគមន៍ពីប្រព័ន្ធនៃភាពត្រូវគ្នាមួយហៅថាក្រមសេនេទិច។
          </li>
          <li>
            ដោយADN មាននុយក្លេអូទីត៤ប្រភេទគឺ A, T, C, G
            យហើយប្រូតេអ៊ីនមានអាស៊ីតអាមីនេ២០ប្រភេទ តើនុយ៤ប្រភេទរបស់ADN
            កំណត់អាស៊ីតអាមីនេទាំង២០ប្រភេទរបស់ប្រូតេអ៊ុនបានដូចម្តេច?
          </li>
        </ul>
      </>
    ),
  ...
  tip: {
    ...
    content: (
      <>
        <ul className="list-disc ml-4 flex flex-col gap-3">
          <li>
            ត្រីធាតុមួយ ឬកូដុងមួយជាព័ត៌មានសម្រាប់កំណត់អាស៊ីតអាមីនេមួយ។
            កូដុងជាបាសបីតគ្នារបស់{" "}
          ...
          <li>
            ក្រមសេនេទិចមានលក្ខណះជាសាកល។
            ភាវរស់ទាំងអស់ចាប់ពីបាក់តេរីទៅមនុស្សមានក្រមសេនេទិចរួមគ្នាតែមួយចំពោះសត្វ
            ក៏ដូចចំពោះរុក្ខជាតិដែរ។
          </li>
          <li>
            គេប្រៀបប្រដូចក្រមសេនេទិចដូចវចនានុក្រម សម្រាប់បកប្រែភាសាអក្សរ ៤
            តួរបស់ ADN ឲ្យទៅជាភាសាអក្សរ២០តួ នៃប្រូតេអ៊ីន។
          </li>
        </ul>
      </>
    ),
