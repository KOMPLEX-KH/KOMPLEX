...
const FirstTopicContent: TopicContent = {
  ...
  tip: {
    ...
    content: (
      <>
        <p>
          ប្រភេទជាក្រុមសារពាង្គកាយដែលមានរូបរាងស្រដៀងគ្នា
          ហើយធ្វើការបន្តពូជជាមួយគ្នាបានដោយបង្កើតកូនចៅដែលអាចបន្តពូជបានទៀត។
        </p>
      </>
    ),
  },
    ...
    content: (
      <>
        <ul className="list-disc ml-4 flex flex-col gap-3">
          <li>
            កាលណាមានរបាំងភូមិសាស្ត្រ ពពួកផ្សេងៗត្រូវបែកចេញពីគ្នា
            មិនអាចមានទំនាក់ទំនងជាមួយគ្នា។ ក្រោម
            ឥទ្ធិពលនៃជម្រើសដោយធម្មជាតិពពួកនីមួយៗមានលក្ខណះបន្សំទៅនឹងមជ្ឈដ្ឋានរៀងខ្លួន។
          </li>
          <li>
            ឆ្លងកាត់រយះពេលដ៏យូរមក ពពួកទាំងនោះមានលក្ខណះខុសគ្នាកាន់តែច្រើនឡើងៗ
            ហើយមិនអាចបន្តពូជជាមួយគ្នាបាន ដូច្នេះវាក៏ក្លាយជាប្រភេទផ្សេងៗពីគ្នា។
          </li>
        </ul>
      </>
    ),
    ...
    content: (
      <>
        <div className="flex flex-col items-start gap-3">
          <p>
            ការលេចឡើងនៃប្រភេទថ្មី បណ្តាលមកពីការកកើតរបាំងបន្តពូជរវាងឯកន្លះ។
            របាំងបន្តពូជ ជារបាំងជីវសាស្ត្រ។
          </p>
          <ul className="list-disc ml-4 flex flex-col gap-3">
            <li>ឯកត្តះមានរូបរាង និងទំហំប្រដាប់បន្តពូជខុសគ្នា។</li>
            <li>ឯកត្តះធ្វើការបន្តពូជនៅរដូវនិងខែខុសគ្នា។</li>
            <li>
              ការទាក់ទាញរវាងសត្វញីឈ្មោល ដើម្បីធ្វើការបន្តពូជមានរបៀបខុសគ្នា។
            </li>
