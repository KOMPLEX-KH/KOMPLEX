    ...
    content: (
      <>
        <ul className="list-disc ml-4 flex flex-col gap-3">
          <li>
            ផូស៊ីល ជាស្នាម ឬសំណល់របស់ភាវៈរស់ជំនាន់ដើម
            ដែលបានបន្សល់ទុកក្នុងស្រទាប់សិលា។
          </li>
          <li>
            ភស្តុតាងដែលបញ្ជាក់ថាភាវៈរស់វិវត្តគឺ ផូស៊ីល
            ការលូតលាស់របស់អំប្រ៊ីយ៉ុងនៃប្រភេទសត្វឆ្អឹងកងផ្សេងៗ
            និងភាពដូចគ្នានៃរូបផ្តុំសារពាង្គកាយ។
          </li>
        </ul>
      </>
    ),
  ...
  tip: {
    ...
    content: (
      <>
        <ul className="list-disc ml-4 flex flex-col gap-3">
          <li>
            អំប្រ៊ីយ៉ុង ជាទម្រង់ដំបូងនៃសារពាង្គកាយដែលលូតលាស់ចាប់ពីស៊ីកូត
  ...
  example: {
    question: [
      <div className="flex flex-col items-start gap-3" key="q1">
        ...
        <p>
          អវៈយវៈខាងមុខ អវៈយវៈក្រោយ សំណុំខួរក្បាលរបស់សត្វឆ្អឹងកងទាំងប្រាំថ្នាក់
          ជាសរីរាង្គអូម៉ូឡូក។
        </p>
      </div>,
    ],
