    ...
    content: (
      <>
        <ul className="list-disc ml-4 flex flex-col gap-3">
          <li>
            ការវិវត្តគឺជាការផ្លាស់ប្តូរជាបន្តបន្ទាប់ក្នុងរយះពេលដ៏យូរអង្វែងនៃទម្រង់របស់សត្វនិងរុក្ខជាតិដែលនាំឲ្យលេចចេញនូវទម្រង់ថ្មីៗផ្សេងទៀតរបស់សត្វ
            ឬរុក្ខជាតិ។
          </li>
          <li>
            បម្រែបម្រួលជាកំណែប្រែ
            ដែលធ្វើឲ្យមានលក្ខណៈខុសគ្នារវាងឯកត្តះនៅក្នុងប្រភេទតែមួយ។
          </li>
        </ul>
      </>
    ),
...
const SecondTopicContent: TopicContent = {
  ...
  tip: {
    ...
    content: (
      <>
        <p>
          នៅក្នុងហ្វូងសត្វចិញ្ចឹមបើមនុស្សសង្កេតឃើញសត្វមានលក្ខណះប្លែក
          ហើយលក្ខណះនោះមានប្រយោជន៍ចំពោះ ខ្លួន
          មនុស្សនឹងជ្រើសរើសយកឯកត្តៈនោះរក្សាទុក
          ហើយធ្វើការបន្តពូជដោយឡែកជាច្រើនជំនាន់។ ការធ្វើបែបនេះ
          គេនឹងទទួលបានពូជសត្វស្រុកមួយបែបថ្មីទៀត។
        </p>
      </>
    ),
  },
