    ...
    content: (
      <>
        <div className="flex flex-col items-start gap-2">
          <p>
            តាមទ្រឹស្តីវិវត្តរបស់ដាវិន
            ជម្រើសដោយធម្មជាតិកើតឡើងបានដោយសារកត្តាមួយចំនួនៈ
          </p>
          <ul className="list-disc ml-4 flex flex-col gap-3">
            ...
            <li>
              ភាវៈរស់ដែលមានបម្រែបម្រួល មានប្រយោជន៍អាចបន្សំនឹងមជ្ឈដ្ឋាន
              អាចរស់នៅនិងបន្តពូជ ហើយបញ្ជូនលក្ខណះរបស់ខ្លួនទៅសន្ដានក្រោយ។
            </li>
            <li>
              ឆ្លងកាត់រយះពេលដ៏យូរ បម្រែបម្រួលមានប្រយោជន៍គរផ្គុំទុកពូជ
              ឬប្រភេទភាវៈរស់ថ្មី។
            </li>
          </ul>
        </div>
