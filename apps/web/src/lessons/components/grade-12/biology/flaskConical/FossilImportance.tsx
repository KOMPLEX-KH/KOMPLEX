    ...
    content: (
      <>
        <ul className="list-disc ml-4 flex flex-col gap-2">
          <li>
            ធ្វើឲ្យយើងស្គាល់ប្រវត្តិនៃការវិវត្តរបស់ភាវៈរស់ដូចជា ការកកើត
            ការរីកចម្រើន និងការវិនាសបាត់បង់ទៅវិញ នៃប្រភេទភាវៈរស់នីមួយៗ។
          </li>
          <li>
            ធ្វើឲ្យយើងស្គាល់ពីប្រវត្តិនៃផែនដី
            ដែលបង្ហាញនូវលក្ខណះអាកាសធាតុនាសម័យកាលនីមួយៗ។
          </li>
        </ul>
      </>
    ),
