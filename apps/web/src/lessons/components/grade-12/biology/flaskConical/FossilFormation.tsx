...
const FirstTopicContent: TopicContent = {
  ...
  tip: {
    ...
    content: (
      <>
        <ul className="list-disc ml-4 flex flex-col gap-3"></ul>
      </>
    ),
  },
  imageExplanation: [
    ...
    content: (
      <>
        <ul className="list-disc ml-4 flex flex-col gap-3">
          <li>
            ពុម្ពក្រៅ: ភាវៈរស់មួយងាប់ ហើយធ្លាក់ក្នុងទឹក វាកប់ជាប់ក្នុងកម្ទេចកំណ។
            បន្ទាប់មកសារពាង្គកាយនោះរលួយបន្សល់តែពុម្ពទទេ
            ដែលបង្ហាញពីរូបរាងនៃភាវៈរស់នោះ។
          </li>
          <li>
            ពុម្ពក្នុង: កើតឡើងដោយមានកម្ទេចកំណ
            ធ្លាក់មកបំពេញពុម្ពក្រៅហើយសូនបានជារូបសារពាង្គកាយនៃភាវៈរស់។
          </li>
        </ul>
      </>
    ),
