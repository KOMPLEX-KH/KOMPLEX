  ...
  },
  {
      ...
      content: (
        <ul className='flex flex-col gap-2 items-start list-disc ml-5'>
            ...
            <li>អរម៉ូនភ្ញោចតែកោសិកាគោលដៅ ដោយសារកោសិកាគោលដៅមានធ្មួលនៅលើភ្នាសកោសិកា។ ធ្មួលកោសិកាគោលដៅមានទម្រង់ត្រូវគ្នា នឹងទម្រង់របស់អរម៉ូន ដែលបង្កើតបានជាសារធាតុចម្រុះអរម៉ូន-ធ្មួល។ សារធាតុចម្រុះនេះហើយ ដែលធ្វើឲ្យកោសិកាគោលដៅឆ្លើយតបទៅនិងអំពើរបស់អរម៉ូន។</li>
        </ul>
      ),
  },
  {
