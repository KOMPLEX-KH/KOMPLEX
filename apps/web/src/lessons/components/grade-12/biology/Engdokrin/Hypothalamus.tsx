...
const TOPIC_CONTENT_V3: TopicContent_V3[] = [
...

  {
        ...
        src: "/docs/grade-12/biology/mixs/pic56.png",
        imageAlt: "រូបភាព",
        explanation: [
        "អ៊ីប៉ូឡាមុសស្ថិតនៅកន្លែងផ្នែកបាតនៃខួរធំ ខាងក្រោមតាឡាមុស​ ។ វាមាននាទីត្រួតពិនិត្យការស្រែកឃ្លាន តំហែរក្សាសីតូណ្ហភាណ​​ តុល្យភាពទឹក និងសម្ពាធឈាម ។ បន្ថែមពី​នេះ អ៊ីប៉ូតាឡាមុសមាននាទីបង្កើតឬភ្ញោចបញ្ចេញអរម៉ូនរបស់ក្រពេញអ៊ីប៉ូភីស ។"
      ],
        title: "អុីប៉ូតាឡាមុស",
  },
