    ...
    content: (
      <>
        <ul className="list-disc ml-4 flex flex-col gap-3">
          <li>
            ការបង្កាត់ជិត គឺជាការបង្កាត់សត្វ
            ដែលកើតចេញពីមេបាមួយគូឬរវាងមេបានិងកូនរបស់វា។
          </li>
          <li>
            ផ្តល់សន្តានក្រោយមានកម្លាំងជីវិតខ្សោយ លទ្ធភាពបន្តពូជថយចុះ
            បង្កើតភាពមិនប្រក្រតីនៃក្រូម៉ូសូម នាំទៅរកការផុតពូជ។
          </li>
          <li>អាចបង្កើតនិងរក្សានូវពូជសុទ្ធ ចំពោះលក្ខណះអន់ដែលគេចង់បាន។</li>
          <li>
            ការបង្កាត់ជិតធ្វើឡើងចំពោះសត្វដែលគេចិញ្ចឹមដូចជា គោ ក្របី ឆ្កែ ឆ្មា
            ជាដើម។
          </li>
        </ul>
      </>
  ...
  tip: {
    ...
    content: (
      <>
        <ul className="list-disc ml-4 flex flex-col gap-3">
          <li>
            ការបង្កាត់រវាងមេបាពូជខុសគ្នា ឬប្រភេទខុសគ្នា
            ឬសែស្រឡាយឆ្ងាយដាច់ពីគ្នា។
          </li>
          <li>
            ផ្តល់អីប្រ៊ីតមានកម្លាំងជីវិតខ្លាំង ធន់នឹងជម្ងឺ ឆាប់លូតលាស់បានល្អ
            ផ្តល់ទិន្នផលខ្ពស់។
          </li>
