...
export const DifferentialEquation: Topic[] = [
  {
    ...
    component: () =>
      import(
        "@/lessons/components/grade-12/math/differential-equation/Differential-Definition"
      ),
  },
  {
    ...
    component: () =>
      import("@/lessons/components/grade-12/math/differential-equation/LDE1"),
  },
  {
    title: "សមីការឌីផែរ៉ង់ស្សែលលីនែអ៌ែរលំដាប់២មានមេគុណថេរ",
    englishTitle: "Linear-differential-equation-homogeneous-order-2",
    component: () =>
      import("@/lessons/components/grade-12/math/differential-equation/LDE2"),
  },
  {
    ...
    component: () =>
      import(
        "@/lessons/components/grade-12/math/differential-equation/LDE-General"
      ),
  },
  {
    ...
    component: () =>
      import(
        "@/lessons/components/grade-12/math/differential-equation/Various-Forms"
      ),
  },
  {
    title: "លំហាត់អនុវត្ត",
    ...
    component: () =>
      import(
        "@/lessons/components/grade-12/math/differential-equation/Differential-Practice"
      ),
  },
];
